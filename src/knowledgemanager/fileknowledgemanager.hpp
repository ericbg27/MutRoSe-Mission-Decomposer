...
class FileKnowledgeManager : public KnowledgeManager {
    public:
        ...
        void initialize_attribute_mapping(SemanticMapping sm, pt::ptree worlddb_root, std::map<std::string,std::string> type_mapping, std::vector<ground_literal>& init, std::vector<std::pair<ground_literal,int>>& init_functions);
        void initialize_ownership_mapping(SemanticMapping sm, pt::ptree worlddb_root, std::map<std::string,std::string> type_mapping, std::vector<ground_literal>& init);
        void initialize_relationship_mapping(SemanticMapping sm, pt::ptree worlddb_root, std::map<std::string,std::string> type_mapping, std::vector<ground_literal>& init);
