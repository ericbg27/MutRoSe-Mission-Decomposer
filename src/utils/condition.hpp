...
class Condition {
    public:
        ...
        std::variant<std::pair<std::pair<predicate_definition,std::vector<std::string>>,bool>,bool> evaluate_condition(std::variant<std::pair<std::string,std::string>,std::pair<std::vector<std::string>,std::string>> var_value_and_type, std::vector<SemanticMapping> semantic_mapping);
