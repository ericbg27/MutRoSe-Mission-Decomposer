...
pandaPIparser: src/hddl-token.o src/hddl.o src/main.o src/sortexpansion.o src/parsetree.o src/util.o src/domain.o src/output.o src/parametersplitting.o src/cwa.o src/typeof.o src/shopWriter.o src/hpdlWriter.o src/hddlWriter.o src/orderingDecomposition.o src/plan.o src/verify.o src/properties.o src/gm.o src/tdg.o src/annotmanager.o src/rannot-token.o src/rannot.o src/at_manager.o src/config.o src/knowledgemanager.o src/knowledgebase.o src/missiondecomposer.o src/constraintmanager.o src/instancesoutput.o
